...
const Footer = () => {
  return (
    <footer className="py-28 bg-gray-950">
      <motion.div
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-14 md:gap-4">
          ...
          <div className="space-y-4 max-w-[300px]">
            <h1 className="text-2xl font-bold text-white">Turfup</h1>
          ...
          <div className="space-y-4 max-w-[300px]">
            ...
            <div className="flex items-center">
              ...
              />
              <button className="bg-black text-white font-semibold py-4 px-6 rounded-e-xl">
                Go
              </button>
            </div>
            {/* social icons */}
            <div className="flex space-x-6 py-3">
              <a href="https://chat.whatsapp.com/FQSKgJ5f1eIAhlyF5sVym0">
                <FaWhatsapp className="cursor-pointer text-white hover:text-white hover:scale-105 duration-200" />
              </a>
              <a href="https://www.instagram.com/the.coding.journey/">
                <FaInstagram className="cursor-pointer text-white hover:text-white hover:scale-105 duration-200" />
              </a>
              <a href="https://thecodingjourney.com/">
                <TbWorldWww className="cursor-pointer text-white hover:text-white hover:scale-105 duration-200" />
              </a>
              <a href="https://www.youtube.com/@TheCodingJourney">
                <FaYoutube className="cursor-pointer text-white hover:text-white hover:scale-105 duration-200" />
              </a>
            </div>
          </div>
        </div>
